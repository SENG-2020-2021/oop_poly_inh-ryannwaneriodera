...
class Main {
  public static void main(String[] args) {
      ...
      case '2':
        ...
        Square sq = new Square(ab);
		System.out.printf("The perimeter of the square with  Side: %.2f is %.2f", ab, sq.calculatePerimeter()); 
		System.out.println("");
		System.out.printf("The area of the square with Side: %.2f is %.2f", ab, sq.area()); 
		break;
      ...
      case '4': 
        ...
        Rectangle rec= new Rectangle(a2,b2);
		System.out.printf("The perimeter of the rectangle with  length: %.2f and breadth %.2f is %.2f", a2,b2, rec.calculatePerimeter()); 
		System.out.println("");
		System.out.printf("The area of the rectangle with length: %.2f and breadth %.2f is %.2f", a2,b2, rec.area()); 
		break;
      ...
      case '5':
		...
		System.out.println("");
		System.out.printf("The perimeter of the parallelogram with First Pair: %.2f and SecondPair: %.2f is %.2f", q.getLength(), q.getBreadth(), p.calculatePerimeter());
		System.out.println("");
		System.out.println("");
		System.out.println("");
		break;
...
class Quadilateral {
  ...
  protected  float diag1;
  protected  float diag2;
  protected  float base;
  protected  float height;
  protected float side5;
